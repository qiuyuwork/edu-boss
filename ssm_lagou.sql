...
(12,'Vue.js 3.0 核心源码解析','掌握框架原理，精通经典应用场景',99.00,'',88.00,'','<p>背景介绍<br>\n在过去的几年里，Vue、React、Angular 一直是国内前端的三大主流框架。在 2019 年 Vue 就像一匹黑马力压群雄，独占前端er 的宠爱，Github Star 排名荣登第一也反映了国内开发者对 Vue 的喜爱。</p>\n<p>最近，Vue 的作者尤雨溪在 Github 上介绍了 Vue 3.0 的最新进展，目标发布日期是 7 月中旬发布 RC 版本，8 月初发布正式版，也就是说 Vue 3.0 就在眼前！</p>\n<p>专栏解读<br>\n专栏将对 Vue.js 3.0 的框架源码进行系统、细致地分析。 深入到内核剖析实现原理，探究源码背后的设计思想。一方面帮你夯实 Vue.js 开发技能，一方面帮你理解源码分析的方式与编程思路，为你从底层逻辑理解优秀框架背后的技术思想。</p>\n<p>专栏主要分为以下3个部分：</p>\n<p>第一部分核心模块，这个部分会带你去分析 Vue.js 3.0 最核心的组件的实现原理以及 Vue.js 3.0 新特性 Composition API 的实现原理。掌握这个部分，可以让你对组件如何渲染和更新能有深刻的理解，并掌握 Composition API 背后的实现原理和应用场景。</p>\n<p>第二部分进阶模块，这个部分会带你分析 Vue.js 3.0 模板的编译和优化过程。带你了解 Vue.js 是如何编译模板并生成代码的，以及编译过程背后的性能优化思想是怎样的。</p>\n<p>第三部分扩展模块，将带你分析 Vue.js 3.0 的内置组件的实现原理、Vue.js 3.0 一些实用特性的实现原理以及 Vue.js 3.0 官方生态实现原理。经过学习，你可以了解这些功能的实现原理和职责边界，在平时工作中应用起来更加得心应手。</p>\n<p>在学习这门课程后，不仅可以了解 Vue.js 3.0 核心实现原理，还能一定程度地了解背后的设计思想。源码中一些好的编程思路和优秀的代码可以吸收来为自己的工作所用，修炼内功，提升技术能力。</p>\n<p>讲师简介<br>\n黄轶（ustbhuangyi） Zoom 前端架构师，前百度、滴滴资深技术专家</p>\n<p>现任 Zoom 前端架构师，主要负责推进前后端分离架构方案和 Zoom 自研组件库，不仅将Vue.js 带入 Zoom，而且通过魔改 Vue.js 源码开发了 Vue.js 2.x 的 CSP 兼容版本，并稳定服务于几十个用 Vue.js 做增强开发的页面。之前，他先后在百度和滴滴担任前端资深技术专家，并曾使用 Vue.js 重构了滴滴出行WebApp，主导开发 Vue.js 开源组件库 cube-ui。</p>\n<p>课程大纲</p>\n','<p>背景介绍<br> 在过去的几年里，Vue、React、Angular 一直是国内前端的三大主流框架。在 2019 年 Vue 就像一匹黑马力压群雄，独占前端er 的宠爱，Github Star 排名荣登第一也反映了国内开发者对 Vue 的喜爱。</p> \n<p>最近，Vue 的作者尤雨溪在 Github 上介绍了 Vue 3.0 的最新进展，目标发布日期是 7 月中旬发布 RC 版本，8 月初发布正式版，也就是说 Vue 3.0 就在眼前！</p> \n<p>专栏解读<br> 专栏将对 Vue.js 3.0 的框架源码进行系统、细致地分析。 深入到内核剖析实现原理，探究源码背后的设计思想。一方面帮你夯实 Vue.js 开发技能，一方面帮你理解源码分析的方式与编程思路，为你从底层逻辑理解优秀框架背后的技术思想。</p> \n<p>专栏主要分为以下3个部分：</p> \n<p>第一部分核心模块，这个部分会带你去分析 Vue.js 3.0 最核心的组件的实现原理以及 Vue.js 3.0 新特性 Composition API 的实现原理。掌握这个部分，可以让你对组件如何渲染和更新能有深刻的理解，并掌握 Composition API 背后的实现原理和应用场景。</p> \n<p>第二部分进阶模块，这个部分会带你分析 Vue.js 3.0 模板的编译和优化过程。带你了解 Vue.js 是如何编译模板并生成代码的，以及编译过程背后的性能优化思想是怎样的。</p> \n<p>第三部分扩展模块，将带你分析 Vue.js 3.0 的内置组件的实现原理、Vue.js 3.0 一些实用特性的实现原理以及 Vue.js 3.0 官方生态实现原理。经过学习，你可以了解这些功能的实现原理和职责边界，在平时工作中应用起来更加得心应手。</p> \n<p>在学习这门课程后，不仅可以了解 Vue.js 3.0 核心实现原理，还能一定程度地了解背后的设计思想。源码中一些好的编程思路和优秀的代码可以吸收来为自己的工作所用，修炼内功，提升技术能力。</p> \n<p>讲师简介<br> 黄轶（ustbhuangyi） Zoom 前端架构师，前百度、滴滴资深技术专家</p> \n<p>现任 Zoom 前端架构师，主要负责推进前后端分离架构方案和 Zoom 自研组件库，不仅将Vue.js 带入 Zoom，而且通过魔改 Vue.js 源码开发了 Vue.js 2.x 的 CSP 兼容版本，并稳定服务于几十个用 Vue.js 做增强开发的页面。之前，他先后在百度和滴滴担任前端资深技术专家，并曾使用 Vue.js 重构了滴滴出行WebApp，主导开发 Vue.js 开源组件库 cube-ui。</p> \n<p>课程大纲</p>','https://edu-lagou.oss-cn-beijing.aliyuncs.com/images/2020/07/17/15949659206804677.png',NULL,NULL,NULL,NULL,'2020-07-10 11:20:43','2020-09-01 11:06:32',0,NULL,'https://edu-lagou.oss-cn-beijing.aliyuncs.com/images/2020/07/10/15943511296066408.png',1,7,'共22节','更新10节',100),
...
(27,'一拳超人','一拳超人',188.00,'',88.00,'一拳超人','<p>一拳超人一拳超人一拳超人一拳超人一拳超人一拳超人一拳超人一拳超人一拳超人一拳超人</p>\n',NULL,'http://localhost:8080/upload/1598930326976.jpg',NULL,NULL,NULL,NULL,'2020-08-12 18:19:16','2020-09-09 11:46:47',0,NULL,'',1,0,'一拳超人','一拳超人',10),
(28,'大是大非三1111111','大是大非三1111',120.00,'',111.00,'的飞洒','<p>富士达发萨发是发送到发as佛挡杀佛四大</p>\n',NULL,'http://localhost:8080/upload/1597229733992.jpg',NULL,NULL,NULL,NULL,'2020-08-12 18:53:42','2020-09-01 11:18:21',0,NULL,'',0,0,'大是大非三','大是大非三',12),
...
(31,'武林外传 第一部','很好看',100.00,'',88.00,'颠三倒四','<p>佛挡杀佛是大算法的浮点数</p>\n',NULL,'http://localhost:8080/upload/1598609312100.jpg',NULL,NULL,NULL,NULL,'2020-08-28 14:31:06','2020-08-28 18:08:50',0,NULL,'',0,0,'高级讲师','高级讲师',12);
...
) ENGINE=InnoDB AUTO_INCREMENT=29 DEFAULT CHARSET=utf8 COMMENT='课程节内容';
...
(28,27,21,'琦玉大战李思思',21,1,'2020-09-01 11:19:25','2020-09-01 11:19:25',0,0,0);
...
(19,27,'第一集','琦玉买菜回家','2020-08-13 14:14:08','2020-08-31 10:57:18',0,1,1),
...
(22,7,'产品分析02','产品分析02','2020-08-31 10:45:57','2020-08-31 10:48:06',0,4,0),
...
(28,-1,'/money','setting','财务管理','管理财务',1,0,0,'2020-08-21 11:51:04','2020-08-21 14:17:07','system','system'),
(29,28,'/nongye','setting','政府财务管理','农业财务管理',2,0,1,'2020-08-21 11:52:07','2020-08-21 14:16:57','system','system'),
(30,28,'JIAOTONG','icon','交通部财务管理','交通部财务管理',6,0,1,'2020-09-02 14:28:50','2020-09-02 14:28:50','system','system'),
(31,-1,'PERSON','icon','人力资源02','人力资源',3,0,0,'2020-09-02 14:29:34','2020-09-02 14:32:40','system','system');
...
(1074,'java高级训练营101期',2,NULL,NULL,'Java高级训练营 Java高级训练营 Java高级训练营','https://localhost:8080/upload','2020-08-17 11:21:27','2020-08-18 17:03:45','2020-07-14 14:28:34','2020-09-08 16:00:33',1,0,'http://localhost:8080/upload/1598878980298.jpg'),
...
(1089,'Java高级训练营',3,NULL,NULL,'广告保存','http://localhost:8080/upload/1597400130127.jpg','2020-08-14 18:15:15','2020-08-15 00:00:00',NULL,'2020-09-10 10:51:59',1,NULL,'http://localhost:8080/upload/1597400130127.jpg'),
...
(1094,'Python高级',1,NULL,NULL,'Python高级Python高级Python高级','www.xxnn.com','2020-08-31 20:46:26','2020-09-09 00:00:00','2020-08-31 20:46:55','2020-08-31 20:46:55',1,NULL,'http://localhost:8080/upload/1598878011866.jpg');
...
(1,'获取所有角色001','/boss/role/all',1,'获取所有角色','2020-09-02 16:44:12','2020-09-02 16:44:12','system','system'),
...
(58,'assa','assa',5,'asdsa','2020-09-02 16:19:49','2020-09-02 16:19:49','system','system'),
(59,'qwe','qwe',6,'wewqeqwe','2020-09-02 16:20:34','2020-09-02 16:20:34','system','system'),
...
CREATE TABLE `role_menu_relation` (
  ...
  `updated_by` varchar(100) NOT NULL COMMENT '更新人',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=340 DEFAULT CHARSET=utf8mb4 COMMENT='角色和菜单关系表';
...
(334,5,7,'2020-09-09 15:26:26','2020-09-09 15:26:26','system','system'),
(335,19,7,'2020-09-09 15:26:26','2020-09-09 15:26:26','system','system'),
(336,20,7,'2020-09-09 15:26:26','2020-09-09 15:26:26','system','system'),
(337,21,7,'2020-09-09 15:26:26','2020-09-09 15:26:26','system','system'),
(338,23,7,'2020-09-09 15:26:26','2020-09-09 15:26:26','system','system'),
(339,24,7,'2020-09-09 15:26:26','2020-09-09 15:26:26','system','system');
...
CREATE TABLE `role_resource_relation` (
  ...
  `updated_by` varchar(100) NOT NULL COMMENT '更新人',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=126 DEFAULT CHARSET=utf8mb4 COMMENT='角色和资源关系表';
...
(119,1,7,'2020-08-24 14:36:37','2020-08-24 14:36:37','system','system'),
(120,9,7,'2020-08-24 14:36:37','2020-08-24 14:36:37','system','system'),
(121,10,7,'2020-08-24 14:36:37','2020-08-24 14:36:37','system','system'),
(122,11,7,'2020-08-24 14:36:37','2020-08-24 14:36:37','system','system'),
(123,12,7,'2020-08-24 14:36:37','2020-08-24 14:36:37','system','system'),
(124,13,7,'2020-08-24 14:36:37','2020-08-24 14:36:37','system','system'),
(125,14,7,'2020-08-24 14:36:37','2020-08-24 14:36:37','system','system');
...
(174,27,'琦玉','高级讲师','一拳超人','2020-08-12 18:19:16','2020-09-01 11:18:49',0),
...
(100030011,'15321919666','https://edu-lagou.oss-cn-beijing.aliyuncs.com/images/2020/06/28/15933251448762927.png','15321919666','123456',NULL,'','','','DISABLE','\0','2020-07-10 10:19:15','2020-07-10 10:19:15'),
(100030012,'15588886623',NULL,'15588886623','123456',NULL,'','','','DISABLE','\0','2020-07-10 10:43:01','2020-07-10 10:43:01'),
(100030013,'15588886665',NULL,'15588886665','123456',NULL,'','','','DISABLE','\0','2020-07-10 11:09:11','2020-07-10 11:09:11'),
(100030014,'15588886664',NULL,'15588886664','123456',NULL,'','','','ENABLE','\0','2020-07-10 11:10:26','2020-07-10 11:10:26'),
(100030015,'15588886663',NULL,'15588886663','123456',NULL,'','','','ENABLE','\0','2020-07-10 11:21:50','2020-07-10 11:21:50'),
(100030016,'15588886644',NULL,'15588886644','123456',NULL,'','','','ENABLE','\0','2020-07-10 11:23:56','2020-07-10 11:23:56'),
(100030017,'15811111111',NULL,'15811111111','123456',NULL,'','','','DISABLE','','2020-07-10 11:25:45','2020-07-13 10:56:31'),
(100030018,'15588886123',NULL,'15588886123','123456',NULL,'','','','ENABLE','\0','2020-07-10 12:17:35','2020-07-10 12:17:35'),
(100030019,'15588886234','https://edu-lagou.oss-cn-beijing.aliyuncs.com/images/2020/07/10/15943594999396473.png','15588886234','123456',NULL,'','','','ENABLE','\0','2020-07-10 12:20:16','2020-07-10 12:20:16'),
(100030020,'18211111111',NULL,'18211111111','123456',NULL,'','','','ENABLE','\0','2020-07-10 13:57:41','2020-07-10 13:57:41'),
(100030021,'15811112222',NULL,'15811112222','123456',NULL,'','','','ENABLE','\0','2020-07-13 11:35:20','2020-07-13 11:35:20'),
(100030022,'15811111122',NULL,'15811111122','123456',NULL,'','','','ENABLE','\0','2020-07-13 17:43:52','2020-07-13 17:43:52'),
(100030026,'15588886666',NULL,'15588886666','123456',NULL,'','','','ENABLE','\0','2020-08-24 17:23:24','2020-08-24 17:23:27');
...
CREATE TABLE `user_role_relation` (
  ...
  `updated_by` varchar(100) NOT NULL COMMENT '更新人',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=utf8mb4 COMMENT='用户和角色关系表';
...
(19,100030011,2,'2020-09-09 16:39:54','2020-09-09 16:39:54','system','system'),
(20,100030011,7,'2020-09-09 16:39:54','2020-09-09 16:39:54','system','system'),
(22,100030020,3,'2020-09-10 11:04:15','2020-09-10 11:04:15','system','system');
